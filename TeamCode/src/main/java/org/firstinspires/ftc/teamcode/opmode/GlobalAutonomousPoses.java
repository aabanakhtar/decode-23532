...
public class GlobalAutonomousPoses {
    ...
    public static class GoalSidePoses {
        ...
        // ROW 2
        public static final Pose END_LINEUP_START_INTAKE2 = new Pose(53.377, 60.020);
        public static final Pose END_INTAKE_START_SCORE2 = new Pose(15.420, 59.308);
        public static final Pose CONTROL1_SCORE_ROW2 = new Pose(74.965, 60.731);

        // ROW 3
        public static final Pose END_LINEUP_START_INTAKE3 = new Pose(53.140, 36.534);
        public static final Pose END_INTAKE_START_SCORE3 = new Pose(15.183, 36.059);
        public static final Pose CONTROL1_SCORE_ROW3 =  new Pose(80.659, 31.789);
